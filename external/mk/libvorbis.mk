all: libvorbis.a libvorbisfile.a

libvorbis.a: analysis.o barkmel.o bitrate.o block.o codebook.o envelope.o floor0.o floor1.o info.o lookup.o lpc.o lsp.o mapping0.o mdct.o psy.o registry.o res0.o sharedbook.o smallft.o synthesis.o tone.o vorbisenc.o window.o
